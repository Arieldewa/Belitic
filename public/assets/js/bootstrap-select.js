!function($) {
    ...
    Selectpicker.prototype = {
        ...
        init: function (e) {
            ...
            var menu = this.$newElement.find('.dropdown-agent');
            var menuArrow = this.$newElement.find('.dropdown-arrow');
            var menuA = menu.find('li > a');
            var liHeight = select.addClass('open').find('.dropdown-agent li > a').outerHeight();
        ...
        createDropdown: function() {
            var drop =
                "<div class='btn-group select'>" +                    
                    ...
                    "<ul class='dropdown-agent' role='agent'>" +
                    "</ul>" +
                "</div>";
         ...
         render:function() {
            ...
            //Set width of select
             if (this.options.width == 'auto') {
                 var ulWidth = this.$newElement.find('.dropdown-agent').css('width');
		...
		clickListener: function() {
            ...
            $('body').on('touchstart.dropdown', '.dropdown-agent', function (e) { e.stopPropagation(); });
            ...
            this.$newElement.on('click', 'li a', function(e){
                ...
                //Dont close on multi choice agent
                if(_this.multiple) {
                    e.stopPropagation();
                }
